...
export default function ContactModule({ onClose }) {
  ...
  return (
    <motion.div
      ...
      className="relative w-[92%] md:w-full md:flex-1 max-w-xl max-h-none md:max-h-full overflow-y-visible md:overflow-y-auto hud-glass p-6 rounded-lg pointer-events-auto z-20 text-[#d2e5ff] hud-scrollbar border-jarvis-blue/30 mx-auto my-4 md:my-0 md:mx-auto"
    >
      {/* Header */}
